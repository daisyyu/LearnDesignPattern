...
public class PlayWithRemote {
    ...
    public static void main(String[] args) {
        ...
        CentralExecutor centralExecutor = new CentralExecutor();

        // Gets the ElectronicDevice to use

        ElectronicDevice newDevice = TVRemote.getDevice();

        // TurnDeviceOn contains the command to turn on the tv
        ...
        CentralExecutor.DeviceButton onPressed = new CentralExecutor.DeviceButton(onCommand);

        // When press() is called theCommand.execute(); executes

        centralExecutor.pressButton(onPressed);
        ...
        onPressed = new CentralExecutor.DeviceButton(offCommand);
        ...
        TurnDeviceVolumeUp volUpCommand = new TurnDeviceVolumeUp(newDevice);

        // Calling the execute() causes volumeUp() to execute in Television

        onPressed = new CentralExecutor.DeviceButton(volUpCommand);
        ...
        CentralExecutor.DeviceButton turnThemOff = new CentralExecutor.DeviceButton(turnOffDevices);

        centralExecutor.pressButton(turnThemOff);

        //----------------------------------------------------------

		/*
         * It is common to be able to undo a command in a command pattern
		 * To do so, CentralExecutor.DeviceButton will have a method called undo
        ...
        System.out.println("=====undo all previous actions======");
        centralExecutor.undoAll();
