package behavioral.interpreter.DerekB;
...
public class MeasurementConversion {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Classes takes the full canonicalName. Package has to be included.
            Class tempClass = Class.forName("behavioral.interpreter.DerekB." + fromConversion);
            ...
            System.out.println("class: " + fromConversion);
            e.printStackTrace();
